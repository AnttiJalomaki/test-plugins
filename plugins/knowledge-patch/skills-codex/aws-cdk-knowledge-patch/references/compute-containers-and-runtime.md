...
Lambda, ECS, EKS, EC2, Auto Scaling, Batch, EMR, and runtime behavior.
...
### Batch default and optimal instance classes

*Batch 2025-10, 2026-01.*

EC2 managed compute environments support default instance classes. `useOptimalInstanceClasses` was briefly deprecated, then undeprecated, and remains supported.
...
### EKS isolated kubectl subnet diagnostic

*Batch 2026-03, 2026-04.*

The diagnostic for isolated kubectl subnets was introduced as an error and then changed to a warning.
