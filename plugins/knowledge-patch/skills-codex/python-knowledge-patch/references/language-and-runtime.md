...
### Finalization-specific failures (Python 3.13; batch `whatsnew-3.13`)
...
### Built-in protocol breaks (Python 3.14; batch `whatsnew-3.14`)
...
### New failure behavior in common libraries (Python 3.15 preview; batch `whatsnew-3.15`)
