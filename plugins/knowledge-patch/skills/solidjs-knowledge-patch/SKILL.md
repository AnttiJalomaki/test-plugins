...
description: "SolidJS current (version null) changes query and action names, JSX and event semantics, router preloading, server-function transport, and Vite-based SolidStart runtime contracts. Load before working with SolidJS."
license: MIT
version: null
metadata:
  author: Nevaberry
