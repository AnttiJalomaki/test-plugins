...
description: Current Codex surfaces add desktop worktrees and automations, remote TUI WebSockets, structured CLI execution, cloud tasks, MCP and plugin administration, configurable approvals, and expanded TUI workflows. Load before working with OpenAI Codex.
license: MIT
version: null
metadata:
  author: Nevaberry
