...
Ethernet, sockets, HTTP, CoAP, MQTT, LwM2M, OpenThread, Wi-Fi, LoRa, and other network-facing protocols.

## Ethernet, PHY, and link-layer behavior
...
## IP, sockets, DNS, and web protocols
...
## Network services, management, and other protocols
...
## Wireless networking and OpenThread
