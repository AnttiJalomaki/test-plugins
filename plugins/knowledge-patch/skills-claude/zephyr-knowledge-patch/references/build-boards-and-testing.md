...
Build configuration, toolchains, board targets, runners, simulators, sysbuild, Twister, ztest, and diagnostics.

## Boards, targets, runners, and simulation
...
## Build system, toolchains, modules, and dependencies
...
## Testing, diagnostics, and developer tools
