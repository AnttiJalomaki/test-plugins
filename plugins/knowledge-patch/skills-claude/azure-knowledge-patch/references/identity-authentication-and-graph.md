...
Credential chains, Azure CLI and PowerShell sign-in, workload identities, claims challenges, MFA, and Graph migration.

## Microsoft Entra, Microsoft Graph, and MFA
...
## Identity SDK credential chains
...
## Assignments and workload identities
