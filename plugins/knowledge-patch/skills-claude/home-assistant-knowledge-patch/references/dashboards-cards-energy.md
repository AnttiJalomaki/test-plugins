...
### Activity and entity interfaces
...
### Contextual dashboard entity names
...
### Dashboard ordering and history
...
### Dashboard, unit, and selector additions
...
### Full-page ZHA device management
...
### Home dashboard mobile navigation and unassigned devices
...
### Infrared and radio-frequency settings panels
...
### Maintenance and Security dashboards
...
### Overview becomes the default Home dashboard
...
### Related-object navigation and creation
...
### System-wide and personal default dashboards
...
## Cards and visual controls

### Card auto height and section spacing
...
### Interactive cards and network editors
...
### Theme and typography token migration
...
## Energy and resource dashboards

### Downstream water meters and dashboard tabs
...
### Energy dashboard live-flow view
...
### Energy dashboard pie charts and totals
...
## Editing, search, and inspection

### Android entity shortcuts
...
### Dashboard visibility and integration search
...
### Discovery diagnostics and shortcuts
